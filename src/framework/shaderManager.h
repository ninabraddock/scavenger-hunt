#ifndef FINAL_PROJECT_NBRADDOC_RROSE1_SHADERMANAGER_H
#define FINAL_PROJECT_NBRADDOC_RROSE1_SHADERMANAGER_H
...
#endif //FINAL_PROJECT_NBRADDOC_RROSE1_SHADERMANAGER_H
